...
class InstructionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        prompt = SYSTEM + SYSTEM_PROMPT + END + USER + ann["question_stem"] + self.get_options(ann) + END + ASSISTANT

        answer_key = ann["answerKey"]+ " " + self.get_answer(ann["choices"], ann["answerKey"]) + "." +ann["fact1"]       
