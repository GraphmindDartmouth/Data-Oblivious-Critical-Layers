...
class GetHookedValue:
    def __init__(self, model_name, device='cpu',checkpoint_value=None,tokneizer=None,fsdp=True):
...
if __name__=="__main__":
    ...
    Hook=GetHookedValue(modelname,device=device,checkpoint_value=step,tokneizer=tokenizer,fsdp=True) 
